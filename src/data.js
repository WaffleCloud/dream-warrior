...
export const pictures = [
    {image: frontProfile, alt: 'front profile'}, 
    {image:boStaff, alt:'bo staff'}, 
    {image:jumpyBoi, alt:'jumpy boi'}, 
    {image: streetBattle, alt: 'battle in the stree'}, 
    {image: zenStatue, alt:'zen statue'}, 
    {image:spartan, alt:'spartan'}, 
    {image:certificate, alt:'certificate'}, 
    {image:intenseFace, alt:'intense face'}, 
    {image:matrix, alt:'matrix'}, 
    {image:casualFull, alt:'casual in park'}, 
